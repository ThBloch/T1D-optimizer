...
The global `session-end-checks.py` Stop hook reminds at session end if `scripts/*.py` was edited without a matching decisions-log entry; non-trivial changes should also produce a new entry in the log.
