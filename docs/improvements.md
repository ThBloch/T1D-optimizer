...
- [x] E8. Phase 4: Dexcom Developer API v3 for insulin events - shipped 2026-06-22. `dexcom_events_fetch.py` + `dexcom_events_loader.py`. EU server provisioned (Individual Access, no DLA required). Authoritative for basal + bolus (fastActing, regular-pen era) + overnight EGV window. Anchor priority: API -> Clarity -> diary -> flag. 120 tests green. See decisions-log 2026-06-22.
